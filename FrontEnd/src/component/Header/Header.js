...
import { 
 ...
 import { search } from './Header.module.css';
     ...
     return (
        <div>
            <Navbar color="dark" light expand="md">
                ...
                <NavbarToggler/>
                <Collapse navbar>
                    <Col className='search' style={search} xs={10}>
                        <input style={search} className="form-control" type="text" placeholder="Search" aria-label="Search"/>
                    </Col>
